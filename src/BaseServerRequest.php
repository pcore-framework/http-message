 ...
 */
class BaseServerRequest extends Request implements ServerRequestInterface
{
     ...
     * @return static
     */
    public static function createFromSwooleRequest($request, array $attributes = []): BaseServerRequest
    {
